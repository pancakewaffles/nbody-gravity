...
# This is, in essence, Euler integration
# Doesn't use numpy, but is more intuitive
...
def calculate_single_body_acceleration(bodies, body_index):
    # Calculates acc for bodies[body_index] using bodies[everything but body_index]
    ...
    for index, external_body in enumerate(bodies):
        if index != body_index:
            ...
            acceleration.x += tmp * (external_body.location.x - target_body.location.x) # Can you figure out why we multiply it with (external_body.location.x - ...)?
